      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex flex-col gap-1 py-4 w-[40%]">
          ...
          <Input
            ...
            placeholder="A catchy name maybe..."
            required
        ...
        <Button
          type="submit"
          disabled={isPending}
          className="bg-white text-black hover:bg-yellow-400 hover:text-white">
          Submit
        </Button>
      </form>
