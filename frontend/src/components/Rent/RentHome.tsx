...
export default function RentHome() {
  return (
    <div className="py-[3%] px-[10%]">
      ...
      />
      <div
        className="offsetEffect generalBorder my-4 flex flex-col gap-2 bg-green-400"
        style={{
        ...
        <Button
          asChild
          className="offsetstyle w-fit flex items-center gap-2 bg-white generalBorder text-black hover:text-white ">
      ...
      <div className="flex justify-between gap-2">
        <div
          className="w-[50%]  bg-yellow-300 generalBorder offsetEffect flex flex-col gap-2"
          style={{
