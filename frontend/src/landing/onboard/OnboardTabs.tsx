  ...
  return (
    <div className="md:w-[60%]">
      <div className="py-4 flex gap-4">
        <Button
          className={twMerge(
            activeTab === "Login" ? "bg-yellow-400" : "bg-gray-300",
            "offsetstyle text-black hover:text-white generalBorder"
          )}
          onClick={() => {
            setActiveTab("Login");
          }}>
        ...
        <Button
          className={twMerge(
            activeTab === "Register" ? "bg-yellow-400" : "bg-gray-300",
            "offsetstyle text-black hover:text-white generalBorder"
          )}
          onClick={() => {
        ...
        {activeTab === "Login" ? (
          <div>
            <h2 className="font-bold text-3xl">
              Login back to your Axon account.
            </h2>
            ...
            <form action="" className="py-6 flex flex-col gap-3 lg:w-[50%]">
              <div>
                ...
                <Input
                  type="email"
                  placeholder="alandoe@email.com"
                  className="offsetEffect generalBorder "
                />
              </div>
              <div>
              ...
              <Button className="bg-green-400 text-black hover:text-white offsetstyle generalBorder">
                Login
              </Button>
            </form>
          </div>
          ...
          <div>
            <h2 className="font-bold text-3xl">Register a new Axon account</h2>
            ...
            <form action="" className="py-6 flex flex-col gap-3 lg:w-[50%]">
              ...
              <Button className="bg-orange-400 text-black hover:text-white offsetstyle generalBorder">
                Register
              </Button>
            </form>
          </div>
