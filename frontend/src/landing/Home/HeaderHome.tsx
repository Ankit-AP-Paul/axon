    ...
    <div className="px-[5%] md:py-[5%] py-[10%] justify-between flex flex-col items-center gap-2">
      <div className="border-2 border-black  w-full rounded-lg offsetstyle">
        <div className="border-b border-black px-[2%] py-1 flex  justify-between items-center">
          ...
          <div className="font-semibold ">Axon</div>
        </div>
        ...
        <div className="px-[2%] py-[5%] flex md:flex-row flex-col justify-between md:items-center bg-teal-150 border-b border-black md:h-[90px]">
          ...
          <Image
            ...
            height={90}
            width={90}
            className="md:h-[90px] h-[40px] aspect-square md:flex hidden"
          />
        </div>
        ...
        <div className="px-[2%] py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex">
              <Image
                ...
                height={150}
                width={150}
                className="md:h-[150px] h-[70px] aspect-square"
              />
              <Image
                src={images.flowers}
                alt="hands"
          ...
          <div className="flex md:flex-row flex-col gap-3 py-6">
            <div className="generalBorder bg-yellow-400 md:w-[30%] offsetEffect">
              ...
              <span>
                Having some resources? some idle computers, some RAM, some GPU?
                then join our network and start earning by renting out your
                resources
              </span>
            </div>
            <div className="generalBorder bg-blue-300 offsetEffect md:w-[30%]">
              ...
              <span>
                ...
                enough compute? You are at the correct place, get your resources
                here from our providers
              </span>
            </div>
        ...
        <div className="px-[2%] border-t border-black py-4 flex justify-between items-center  gap-[2%]">
          <div className="flex flex-wrap md:w-[60%]   gap-[2%]">
            <Button className="bg-orange-700 offsetstyle rounded-md border border-black">
              Become a Provider
            </Button>
            <Button className="bg-green-900 offsetstyle rounded-md border border-black">
              Rent a machine
            </Button>
            <Button className="bg-blue-900 offsetstyle rounded-md border border-black">
